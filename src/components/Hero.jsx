        ...
        <section className="bg-cream-fundo-alternativo w-full min-h-1/2 py-15 px-50">
            <div className="grid grid-cols-2 items-center gap-[60px]">
                <div className="flex flex-col">
                    ...
                    <h1 className="leading-tight font-serif text-7xl text-coffee-primaria mb-4 mt-4">Estilo que fala por <span className="italic text-amber-soft-secundario">você</span> </h1>
